...
During the first semester of my senior year, I began self-studying real analysis and after playing with proofs with definitions, I proved the generalize triangle inequality using an induction technique similar to that used to prove (4.1).
\begin{theorem}
    ...
    Analysis is fun and by far one of my favorite fields of math to date. I am currently working on a proof that shows this holds for all complex numbers as well. 
\end{theorem}
